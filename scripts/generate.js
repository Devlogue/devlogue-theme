 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} devlogue - Devlogue color variables.
...
const transformSoft = theme => {
    ...
    const brightColors = [...soft.devlogue.ansi, ...soft.devlogue.brightOther];
...
module.exports = async () => {
    const yamlFile = await readFile(
        join(__dirname, '..', 'src', 'devlogue.yml'),
        'utf-8'
    );
